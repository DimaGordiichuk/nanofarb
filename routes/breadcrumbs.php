...
// Home
Breadcrumbs::for('home', function ($trail, string $endName = '') {
...
Breadcrumbs::for('categories', function ($trail, $category = null) {
    $trail->parent('home');
...
// Home > News > Some news
Breadcrumbs::for('news.show', function ($trail, $node) {
