...
$html = ' <ul>
        ...
        foreach ($s->body->ul as $element) {
            foreach ($element as $value) {
                ...
                $color_code = get_string_between($color_code, '#', ';');

                $colors_facade[] = ['name' => $color_name, 'type' => 'facade', 'code' => $color_code];
            }
        }
        ...
        foreach ($s2->body->ul as $element) {
            foreach ($element as $value) {
                ...
                $colors_interior[] = ['name' => $color_name, 'type' => 'interior', 'code' => $color_code];
            }
        }
